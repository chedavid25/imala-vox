...
export function TrialExpiredGate() {
  ...
  return (
    <>
      <div className="fixed inset-0 z-50 overflow-y-auto overflow-x-hidden bg-[#1F1F1E]">
        ...
        <nav className="sticky top-0 z-10 bg-[#1F1F1E]/95 backdrop-blur-xl border-b border-white/5 shadow-2xl">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-4">
            <div className="flex items-center gap-2 shrink-0">
              ...
              <span className="text-white font-bold text-base sm:text-lg tracking-tight">Imalá Vox</span>
            </div>
            <a
              href={SUPPORT_WA}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm font-medium text-white/60 hover:text-white transition-colors shrink-0"
            >
            ...
            {plans.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Price */}
                  <div className="p-5 sm:p-8 space-y-1">
                  ...
                  {/* Features */}
                  <div className={cn("flex-1 px-5 sm:px-8 pb-5 sm:pb-8 space-y-3 border-t", isPro ? "border-black/10" : "border-white/5")}>
